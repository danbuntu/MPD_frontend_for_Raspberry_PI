...
<div class="container">
        ...
        <div class="row topPad">
            <div class="btn-group-wrap">
                <div class="center-block">
                    <button id="playlist" class="btn"><span class="glyphicon glyphicon-th-list"></span></button>
                    <button id="search" class="btn"><span class="glyphicon glyphicon-search"></span></button>
                    <button id="options" class="btn"><span class="glyphicon glyphicon glyphicon-cog"></span></button>
    ...
    <div id="optionsWell" class="playlist well">
        <button id="optionsplayer" class="btn center-block"><span class="glyphicon glyphicon-circle-arrow-up"></span>
        </button>
    ...
    <div id="playlistWell" class="playlist well">
        ...
        <button id="playlistplayer" class="btn center-block"><span class="glyphicon glyphicon-circle-arrow-up"></span>
        </button>

        <div id="playlistMessage" class="alert alert-success message"></div>
        <h4 class="text-center"> <span id="playlistcount"></span> items in playlist  - click to remove</h4>
        <div class="row">
        <button type="button" class="btn listcontrol pull-left" data-name="shuffle" id="shuffle">Shuffle Playlist
        </button>
        <button type="button" class="btn listcontrol pull-right" data-name="clear" id="clear">Clear Playlist</button>
        </div>
<div class="row">
    ...
    <div id="searchWell" class="playlist well">
        <a id="top"></a>
        <button id="searchlistplayer" class="btn center-block"><span class="glyphicon glyphicon-circle-arrow-up"></span>
        </button>
        ...
        <div id="allSearch" class="btn-group control-buttons radio text-center">
            <button type="button" class="btn bulksearchArtists mobileText">All Artists</button>
            <button type="button" class="btn bulksearchAlbums mobileText">All Albums</button>
            <button type="button" class="btn advancedSearch mobileText">Advanced</button>
